...
const Wheater = ({ label, isCek, onCheckboxChange, submit, title }) => {
    /*const {
    title,
    val,
    ...
    useEffect(() => {
        ...
        fetchData();
        const interval = setInterval(fetchData, 5000); // set interval untuk memperbarui data setiap 5 detik
    }, []);
